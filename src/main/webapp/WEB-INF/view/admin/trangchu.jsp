    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card ">
                    <div class="card-header ">
                        <h5 class="card-title">Sản phẩm bán chạy nhất trong tháng</h5>
                    ...
                    <div class="card-footer ">
                        <div class="legend">
                            <i class="fa fa-circle text-primary"></i> Bitis1
                            <i class="fa fa-circle text-warning"></i> Bitis2
                            <i class="fa fa-circle text-danger"></i> Bitis3
                            <i class="fa fa-circle text-gray"></i> Bitis4
                        </div>
                        <hr>
                        <div class="stats">
                            <i class="fa fa-calendar"></i> Xem Chi Tiết
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="card card-chart">
                    <div class="card-header">
                        <h5 class="card-title">10 Sản phẩm bán chạy nhất trong tháng</h5>
