                            ...
                            <div class="card card-outline">
                                <div class="card-body pad">
                                    ...
                                    <div class="modal-body">
                                        <form:form action="/updatenh" method="post" modelAttribute="updatecategory"
                                                   onsubmit="if(!confirm('Bạn Muốn Cập Nhật Nhãn Hiệu?')){return false}else{alert('Cập Nhật Nhãn Hiệu Thành Công');}"
                                                   id="formCategory">
                                            <label>ID</label>
                                            <input type="text" class="form-control" name="id"
                                                   value="${nh.id}" readonly>
                                            <label>Tên Nhãn Hiệu</label>
                                            <input type="text" class="form-control" name="name_"
                                                   value="${nh.name_}"
                                                   placeholder="Nhập Nhãn Hiệu"><form:errors path="name_"/><br>
                                            <input type="hidden" name="create_date"
                                                   value="${nh.create_date}" readonly>
                                            <br>
                                            <label>Trạng thái</label>
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" id="active"
                                                           <c:if test="${nh.status_ == 1}">checked</c:if>>
