                            ...
                            <div class="card card-outline">
                                <div class="card-body pad">
                                    <header class="card-header">
                                        ...
                                        <h2 class="card-title">Thêm Màu Sắc</h2>
                                    </header>
                                        ...
                                        <form id="formCategory">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    ...
                                                    <label class="custom-control-label" for="active">Kích hoạt màu sắc</label>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <a type="button" class="btn btn-secondary" data-dismiss="modal" href="/listms">Hủy</a>
